function config_ops($stateProvider, $ocLazyLoadProvider) {
    ...
    }).state('infosys.businfo', {
        url: "infosys_businfo",
        data: {pageTitle: '业务信息'},
        templateUrl: "views/ops/businfo.html?v=" + version
    }).state('infosys.devops', {
        url: "infosys_devops",
        data: {pageTitle: '运维管理系统'},
        templateUrl: "views/ops/devops.html?v=" + version
    }).state('infosys.bushistory', {
        url: "infosys_bushistory",
        data: {pageTitle: '历史表'},
        templateUrl: "views/ops/bushistory.html?v=" + version
    })
