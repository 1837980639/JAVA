...
function rendersourcemark(data, type, full) {
    if (angular.isUndefined(data)) {
        data = "";
    }
    if (full.tsourcemarkstatus == "true") {
...
function cgjblistCtl($confirm, $timeout, $localStorage, notify, $log, $uibModal,
    ...
    $scope.dtColumns = [
        ...
        DTColumnBuilder.newColumn('fsourcemark').withTitle('来源详情(变更前)').withOption(
            'sDefaultContent', '').renderWith(renderDTFontColorGreenH),
        DTColumnBuilder.newColumn('tsourcemark').withTitle('来源详情(变更后)').withOption(
            'sDefaultContent', '').renderWith(rendersourcemark),
...
function zccgjbCtl(DTOptionsBuilder, DTColumnBuilder, $compile, $window,
    ...
    $scope.dtColumns = [
        ...
        DTColumnBuilder.newColumn('tbatch').withTitle('批次号').withOption(
            'sDefaultContent', '').renderWith(renderbatch),
        DTColumnBuilder.newColumn('tsourcemark').withTitle('来源详情').withOption(
            'sDefaultContent', '').renderWith(rendersourcemark),
