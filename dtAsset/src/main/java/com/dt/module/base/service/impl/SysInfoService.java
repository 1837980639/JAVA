...
public class SysInfoService extends BaseService {
    ...
    public R uploadSysInfo() {
        ...
        String cnt=DB.instance().uniqueRecord("select count(1) cnt from res where dr='0'").getString("cnt");
        ...
        params.append("&ct=c:"+cnt);
        try {
            params.append(",p:" + SysInfoService.getLocalPort());
