...
public class ResCBasicinformationItem extends BaseModel<ResCBasicinformationItem> {
    ...
    @TableField("tsourcemark")
    private String tsourcemark;


    @TableField("fsourcemark")
    private String fsourcemark;

    @TableField("tsourcemarkstatus")
    private String tsourcemarkstatus;

    public String getTsourcemark() {
        return tsourcemark;
    }

    public void setTsourcemark(String tsourcemark) {
        this.tsourcemark = tsourcemark;
    }

    public String getFsourcemark() {
        return fsourcemark;
    }

    public void setFsourcemark(String fsourcemark) {
        this.fsourcemark = fsourcemark;
    }

    public String getTsourcemarkstatus() {
        return tsourcemarkstatus;
    }

    public void setTsourcemarkstatus(String tsourcemarkstatus) {
        this.tsourcemarkstatus = tsourcemarkstatus;
    }
