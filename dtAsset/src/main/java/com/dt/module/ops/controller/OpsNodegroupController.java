 ...
 */
@Controller
@RequestMapping("/api/ops/opsNodegroup")
public class OpsNodegroupController extends BaseController {
	...
	public R deleteById(@RequestParam(value = "id", required = true, defaultValue = "") String id) {
		return R.SUCCESS_OPER(OpsNodegroupServiceImpl.removeById(id));
	}
	...
	public R selectById(@RequestParam(value = "id", required = true, defaultValue = "") String id) {
		return R.SUCCESS_OPER(OpsNodegroupServiceImpl.getById(id));
	}

	@ResponseBody
	@Acl(info = "插入", value = Acl.ACL_USER)
	@RequestMapping(value = "/insert.do")
	public R insert(OpsNodegroup entity) {
		return R.SUCCESS_OPER(OpsNodegroupServiceImpl.save(entity));
	}

	@ResponseBody
	@Acl(info = "根据Id更新", value = Acl.ACL_USER)
	@RequestMapping(value = "/updateById.do")
	public R updateById(OpsNodegroup entity) {
		return R.SUCCESS_OPER(OpsNodegroupServiceImpl.updateById(entity));
	}

	@ResponseBody
	@Acl(info = "存在则更新,否则插入", value = Acl.ACL_USER)
	@RequestMapping(value = "/insertOrUpdate.do")
	public R insertOrUpdate(OpsNodegroup entity) {
		return R.SUCCESS_OPER(OpsNodegroupServiceImpl.saveOrUpdate(entity));
	}
	...
	public R selectPage(String start, String length, @RequestParam(value = "pageSize", required = true, defaultValue = "10")  String pageSize,@RequestParam(value = "pageIndex", required = true, defaultValue = "1")  String pageIndex) {
		...
		QueryWrapper<OpsNodegroup> ew = new QueryWrapper<OpsNodegroup>();
		//ew.and(i -> i.eq("user_id", getUserId()).apply(pagesize>10, "rtime>sysdate-1","23"));
		IPage<OpsNodegroup> pdata = OpsNodegroupServiceImpl.page(new Page<OpsNodegroup>(pageindex, pagesize), ew);
