...
//            + "(select name from sys_dict_item where dr='0' and dict_item_id=t.loc and dict_id = 'sysloc' ) syslocstr,  "
            + "(select name from ops_nodegroup where dr='0' and id=t.loc ) syslocstr,  "
     ...
     * @param search
     */
    public R selecArchList(String search) {
        String sql = OpsNodeService.sql + " and arch='1'";
        if (ToolUtil.isNotEmpty(search)) {
            sql = sql + " and (name like '%" + search + "%' or ip like '%" + search + "%' or leader like '%" + search
                    + "%' or mark like '%" + search + "%')";
        }
...
//        }
    ...
    public R selectDBList(String dbinstid, String nodeid) {
        String sql = "select  "
                ...
                + "and a.dr='0' and b.dr='0' and a.type='dbinstance' and b.arch='0' ";
